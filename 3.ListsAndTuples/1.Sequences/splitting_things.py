...
# solution 1 replace each value with it's integer counter part
for index in range(len(values_list)):
    values_list[index] = int(values_list[index])  # convert to integer

print(values_list)
# Solution 2 create a new list and append integer values to it
integer_values = []
